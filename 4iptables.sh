...
#Allow outgoing HTTP(S) sessions for apt-get update and browsing
...
#Allow DHCP handshakes for dynamic IP-address assignment
...
#Allow outgoing NTP time sync streams
...
#Make sure nothing goes in or out from this host
